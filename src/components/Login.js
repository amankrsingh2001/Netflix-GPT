...
const signUpButtonHandler = (e) =>{
 ...
 const message = checkValidData(emailValid,passwordValid,name.current.value)
 setErrorMessage(message)
 if(message) return ;
  ...
  return (
    <div className="">
      ...
      </div>
     {
      ...
      <input ref={email} type="text" placeholder="Email Address" className="p-4 my-2 w-full bg-transparent border-[1px] border-slate-500 outline-none rounded-md"/>
      <input ref={password} type="password" placeholder="Password" className="p-4 my-2 w-full bg-transparent  border-[1px]  border-slate-500 rounded-md" />
      <p className="text-[#E50815] m-2 p-2 font-bold text-md">{errorMessage}</p>
      <button className="py-2 my-2 bg-[#E50815] rounded-md w-full" onClick={loginButtonHandler} >Sign In</button>
      ...
      <div>
      <input className="p-4 my-2  bg-transparent border-[1px] outline-none rounded-md" type="checkbox" id="check"/>
     ...
     <input ref={name} type="text" placeholder="Full Name" className="p-4 my-2 w-full bg-transparent border-[1px] border-slate-500 outline-none rounded-md"/>
     <input ref={email} type="text" placeholder="Email Address" className="p-4 my-2 w-full bg-transparent border-[1px] border-slate-500 outline-none rounded-md"/>
     <input ref={password} type="password" placeholder="Password" className="p-4 my-2 w-full bg-transparent  border-[1px]  border-slate-500 rounded-md" />
     <p>{errorMessage}</p>
     <button className="py-2 my-2 bg-[#E50815] rounded-md w-full"  onClick={signUpButtonHandler}>Sign UP</button>
